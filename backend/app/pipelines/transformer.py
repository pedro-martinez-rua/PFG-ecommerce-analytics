...
FIELD_TRANSFORMATIONS: dict[str, callable] = {
    ...
    "ad_spend":             parse_decimal,
    "roas":                 parse_decimal,
    "ctr":                  parse_decimal,
    "cost_per_click":       parse_decimal,
    "cost_per_conversion":  parse_decimal,
    "impressions":          parse_int,
    "clicks":               parse_int,
    "conversions":          parse_int,
    "pageviews":            parse_int,
    "delivery_days":        parse_int,
    "is_returned":          parse_boolean,
    "is_refunded":          parse_boolean,
    "is_bounce":            parse_boolean,
    "is_primary_item":      parse_boolean,
    ...
    "shipping_city":        clean_string,
    "postal_code":          clean_string,
    "shipping_address":     clean_string,
    "shipping_type":        clean_string,
    "currency":             clean_string,
    "utm_source":           clean_string,
    "utm_campaign":         clean_string,
    "utm_medium":           clean_string,
    "utm_content":          clean_string,
    "utm_term":             clean_string,
    "device_type":          clean_string,
    "session_id":           clean_string,
    "landing_page":         clean_string,
