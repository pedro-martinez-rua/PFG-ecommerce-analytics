...
class OrderLine(Base):
    """
    Líneas de pedido. Necesarias para KPIs de producto:
    top productos, ventas por categoría, margen por producto.
    
    product_id es nullable porque algunos datasets no tienen
    catálogo — en ese caso product_name va directo en la línea.
    
    is_primary_item viene del dataset Maven para identificar
    el producto principal cuando hay varios en un pedido.
    """
